        ...
        <div class="ps-contact">
            <div class="container">
                <ul class="ps-breadcrumb">
                    ...
                    <li class="ps-breadcrumb__item active" aria-current="page">კონტაქტი</li>
                </ul>
                <div class="ps-contact__content">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="ps-contact__info">
                                <h2 class="ps-contact__title">რით შეგვიძლია დახმარება?</h2>
                                <p class="ps-contact__text">ჩვენი მხარდაჭერის გუნდი ყოველთვის ხელმისაწვდომია!</p>
                                <h3 class="ps-contact__fax">- - -</h3>
                                ...
                                <ul class="ps-social">
                                    <li><a class="ps-social__link facebook" href="{{ App\Http\Helpers\views::getOptionValue('fb_link', $contacts) }}"><i class="fa fa-facebook"> </i><span class="ps-tooltip">Facebook</span></a></li>
                                    <li><a class="ps-social__link instagram" href="{{ App\Http\Helpers\views::getOptionValue('inst_link', $contacts) }}"><i class="fa fa-instagram"></i><span class="ps-tooltip">Instagram</span></a></li>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="ps-form__group">
                                    <input class="form-control ps-form__input" type="text" placeholder="სახელი">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="ps-form__group">
                                    <input class="form-control ps-form__input" type="email" placeholder="ელ-ფოსტა">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="ps-form__group">
                                    <input class="form-control ps-form__input" type="text" placeholder="ტელეფონი">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="ps-form__group">
                                    <textarea class="form-control ps-form__textarea" rows="5" placeholder="შეტყობინება"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="ps-form__submit">
                            <button class="ps-btn ps-btn--warning">გაგზავნა</button>
                        </div>
                    </div>
                </form>
            </div>
